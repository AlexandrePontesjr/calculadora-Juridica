...
export const legalTableSources = [
  {
    id: "CAT-001",
    document: "09 - CARTILHA PROMOÇÃO.pdf",
    title: "Progressão vertical por titularidade dos médicos",
    kind: "carreira",
    audience: "medicos",
    pages: "8",
    effectivePeriod: "Estrutural, sem vigência financeira",
  ...
  },
  {
    id: "CAT-002",
    document: "09 - CARTILHA PROMOÇÃO.pdf",
    title: "Promoção vertical dos profissionais e trabalhadores de saúde",
    kind: "carreira",
  ...
  },
  {
    id: "CAT-003",
    document: "09 - CARTILHA PROMOÇÃO.pdf",
    title: "Enquadramento por tempo de serviço nas referências",
    kind: "enquadramento",
    audience: "misto",
    pages: "13",
    ...
    status: "estrutural",
    manualReviewRequired: false,
    notes: "Exige interpretação por faixas de tempo; sem campos financeiros.",
    analysisFile: "analise-cartilha-promocao.md",
  },
  {
    id: "CAT-004",
    document: "Lei n. 4.852/2019",
    title: "Anexo I - Vencimento e gratificação de saúde dos servidores do Sistema Estadual de Saúde",
    kind: "remuneracao",
    audience: "servidores_nao_medicos",
    pages: "2",
    ...
    manualReviewRequired: false,
    notes: "Cargo agregado por grupo; coluna de limite máximo/mínimo exige leitura cuidadosa.",
    analysisFile: "analise-lei-4852-2019.md",
  },
  {
    id: "CAT-005",
    document: "Lei n. 4.852/2019",
    title: "Anexo II - Remuneração dos médicos",
    kind: "remuneracao",
    audience: "medicos",
    pages: "3",
    effectivePeriod: "2019-05-01",
    ...
    status: "pronta_para_carga",
    manualReviewRequired: false,
    notes: "Cabeçalho com ruído visual; preservar semântica entre classe e nível.",
    analysisFile: "analise-lei-4852-2019.md",
  },
  {
    id: "CAT-006",
    document: "Lei n. 5.771/2022-01",
    title: "Anexo I - Médicos de 2022-01-01 a 2022-04-30",
    kind: "remuneracao",
    audience: "medicos",
    pages: "2",
    ...
    status: "pronta_para_carga",
    manualReviewRequired: false,
    notes: "Compartilha página com o anexo seguinte; evitar mistura de vigências.",
    analysisFile: "analise-lei-5771-2022-01.md",
  },
  {
    id: "CAT-007",
    document: "Lei n. 5.771/2022-01",
    title: "Anexo II - Médicos a contar de 2022-05-01",
    kind: "remuneracao",
    audience: "medicos",
    pages: "2",
    ...
    status: "pronta_para_carga",
    manualReviewRequired: false,
    notes: "Mesmo layout do anexo anterior; vigência precisa ser atributo de primeira classe.",
    analysisFile: "analise-lei-5771-2022-01.md",
  },
  {
    id: "CAT-008",
    ...
    status: "pronta_para_carga",
    manualReviewRequired: false,
    notes: "Quebra entre páginas; grupo VII fragmentado.",
    analysisFile: "analise-lei-5771-2022-01.md",
  },
  {
    id: "CAT-009",
    ...
    notes: "Há valores com vírgula ausente em parte da extração; revisar antes de carga.",
    analysisFile: "analise-lei-5771-2022-01.md",
  },
  {
    id: "CAT-010",
    document: "Lei n. 5.928/2022-06",
    title: "Anexo I - Remuneração dos médicos",
    kind: "remuneracao",
    audience: "medicos",
    pages: "3",
    ...
    manualReviewRequired: true,
    notes: "Tabela rasterizada; requer digitação ou conferência humana dos valores.",
    analysisFile: "analise-lei-5928-2022-06.md",
  },
  {
    id: "CAT-011",
    document: "Lei n. 5.928/2022-06",
    title: "Anexo II - Vencimento e gratificação de saúde dos servidores do Sistema Estadual de Saúde",
    kind: "remuneracao",
    audience: "servidores_nao_medicos",
    pages: "4",
    effectivePeriod: ">= 2022-06-01",
  ...
  },
  {
    ...
    status: "saneamento_numerico",
    manualReviewRequired: true,
    notes: "Valores e cabeçalhos aparecem fragmentados em linhas; requer normalização.",
  ...
  },
  {
    ...
    status: "saneamento_numerico",
    manualReviewRequired: true,
    notes: "Continuação em duas páginas e células quebradas; normalização obrigatória.",
    analysisFile: "analise-lei-6460-2023.md",
  },
  {
    id: "CAT-014",
  ...
  },
  {
    ...
    status: "saneamento_numerico",
    manualReviewRequired: true,
    notes: "Grupo VII exige subgrupo; há inconsistências de pontuação em alguns valores.",
    analysisFile: "analise-lei-7014-2024.md",
  },
  {
    id: "CAT-016",
    document: "Lei n. 7.799/2025",
    title: "Anexo I - Série de remuneração dos médicos",
    kind: "remuneracao",
    audience: "medicos",
    pages: "2-8",
    ...
    status: "saneamento_numerico",
    manualReviewRequired: true,
    notes: "Série de 13 quadros mensais; cabeçalhos e alguns números exigem saneamento.",
    analysisFile: "analise-lei-7799-2025.md",
  },
  {
    id: "CAT-017",
    document: "Lei n. 7.799/2025",
    title: "Anexo II - Série de vencimento e gratificação de saúde dos servidores do Sistema Estadual de Saúde",
    kind: "remuneracao",
    audience: "servidores_nao_medicos",
    pages: "9-21",
    effectivePeriod: "2025-10-01 e 2026-01-01 a 2026-12-01",
    ...
    status: "saneamento_numerico",
    manualReviewRequired: true,
    notes: "Série de 13 quadros mensais; grupo VII deve manter subgrupo.",
    analysisFile: "analise-lei-7799-2025.md",
  },
