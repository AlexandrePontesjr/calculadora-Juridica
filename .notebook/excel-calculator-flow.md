...
- A janela operacional da planilha agora considera 60 meses retroativos mais 12 meses adicionais a partir da data de propositura da acao informada na tela de detalhe. Competencias futuras sem contracheque carregado sao projetadas em `frontend/src/utils/paystubCalculations.ts` a partir do ultimo contracheque valido carregado, e recalculadas em `frontend/src/data/promotionCalculator.ts` para a competencia futura.
